...
var initWebRoutes = function initWebRoutes(app) {
  ...
  router.post("/api/save-infor-doctors", _doctorController["default"].postInfoDoctor);
  ...
  router.post("/api/verify-booked-appointment", _patientController["default"].postVerifyBookedAppointment);
  router.post("/api/create-new-specialty", _specialtyController["default"].createSpeialty);
